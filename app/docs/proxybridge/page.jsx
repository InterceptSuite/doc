...
export const metadata = {
  title: 'ProxyBridge Documentation',
  description: 'Browse all ProxyBridge documentation articles.',
}
...
export default function ProxyBridgeDocsPage() {
    ...
    <>
      ...
      <main className="pt-28 pb-24">
        <div className="mx-auto w-full max-w-[1200px] px-6">
          <div className="mb-14">
            <p className="text-xs font-semibold uppercase tracking-widest text-accent-light mb-3">ProxyBridge</p>
            <h1 className="text-4xl font-bold text-content tracking-tight mb-3">ProxyBridge Documentation</h1>
            <p className="text-content-muted max-w-xl">
              Route any application through InterceptSuite, regardless of its own proxy settings.
            </p>
          </div>

          <div className="space-y-14">
            {proxyBridgeNavigation.map((group) => {
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {group.items.map((navItem) => {
                      ...
                      return (
                        <Link
                          key={navItem.slug}
                          href={`/docs/proxybridge/${navItem.slug}`}
