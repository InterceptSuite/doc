export const docNavigation = [
  {
    ...
    items: [
      ...
      { title: 'Install on Windows', slug: 'installation-windows', description: 'Install InterceptSuite on Windows.' },
      { title: 'Install on macOS', slug: 'installation-macos', description: 'Install InterceptSuite on macOS.' },
      { title: 'Install on Linux', slug: 'installation-linux', description: 'Install InterceptSuite on Linux.' },
      { title: 'License Activation', slug: 'license-activation', description: 'Activate your Professional Edition license key.' },
      { title: 'Quick Start (Windows)', slug: 'quick-start-windows', description: 'Get up and running on Windows.' },
      { title: 'Quick Start (macOS)', slug: 'quick-start-macos', description: 'Get up and running on macOS.' },
      { title: 'Quick Start (Linux)', slug: 'quick-start-linux', description: 'Get up and running on Linux.' },
    ],
  },
  {
    category: 'Features',
...
export const proxyBridgeNavigation = [
  {
    ...
    items: [
      ...
      { title: 'Why ProxyBridge?', slug: 'why-proxybridge', description: 'Why ProxyBridge is better than standard OS proxies and alternatives.' },
      { title: 'Install on Windows', slug: 'installation-windows', description: 'Install ProxyBridge on Windows.' },
      { title: 'Install on macOS', slug: 'installation-macos', description: 'Install ProxyBridge on macOS.' },
      { title: 'Install on Linux', slug: 'installation-linux', description: 'Install ProxyBridge on Linux.' },
    ],
  },
  {
    ...
    color: '#3B82F6',
    items: [
      { title: 'Windows', slug: 'configuration-windows', description: 'Configure ProxyBridge on Windows.' },
      { title: 'macOS', slug: 'configuration-macos', description: 'Configure ProxyBridge on macOS.' },
      { title: 'Linux', slug: 'configuration-linux', description: 'Configure ProxyBridge on Linux.' },
    ],
  },
]
